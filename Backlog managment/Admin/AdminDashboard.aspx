<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admindash.Master" AutoEventWireup="true" CodeBehind="AdminDashboard.aspx.cs" Inherits="Backlog_managment.Admin.AdminDashboard" %>
...
using (SqlConnection connection = new SqlConnection(connectionStringgg))
{
    string query = "SELECT SUM(Amount) AS TotalPaymentPaid FROM Payment";
...
<div class="row">
    <div class="col-sm-4 grid-margin">
        <div class="card">
            <div class="card-body">
                <h5>Number Of Backlog Students</h5>
                <div class="row">
    ...
    <tbody>
       ...
       // string registrationNumber = Session["RegistrationNumber"] as string;
        ...
        using (SqlConnection connectiong = new SqlConnection(connectionStringg))
        {
            ...
            string queryg = "SELECT semester, course_code, course_name, total_marks, obtained_marks, backlog_fee FROM backlog";
